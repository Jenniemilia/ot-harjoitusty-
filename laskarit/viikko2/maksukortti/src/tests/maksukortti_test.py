...
class TestMaksukortti(unittest.TestCase):
	...
	def test_kortin_saldo_ei_ylita_maksimiarvia(self):
		self.kortti.lataa_rahaa(200)
		self.assertEqual(str(self.kortti), "Kortilla on rahaa 150 euroa")

	def test_negatiivinen_luku_ei_muuta_saldoa(self):
		self.kortti.lataa_rahaa(-20)
		self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

	def test_kortilla_voi_ostaa_edullisen_lounaan_saldolla_2_50(self):
		self.kortti.syo_edullisesti()
		self.kortti.syo_edullisesti()
		self.kortti.syo_edullisesti()
		self.kortti.syo_edullisesti()
	...
	def test_kortilla_voi_ostaa_maukkaa_lounaan_saldolla_4(self):
		self.kortti.syo_maukkaasti()
		self.kortti.syo_maukkaasti()
